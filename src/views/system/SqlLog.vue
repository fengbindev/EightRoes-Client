    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="48">
          ...
          <a-col :md="5" :sm="15">
            <a-form-item label="预编译sql">
              <a-input placeholder="请输入" v-model="queryParam.message"/>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="24">
...
import { getSqlLog } from '@/api/system'
...
export default {
  ...
  data () {
    return {
      ...
      loadData: parameter => {
        return getSqlLog(Object.assign(parameter, {
          ip: this.queryParam.ip ? this.queryParam.ip.trim() : '',
          message: this.queryParam.message ? this.queryParam.message.trim() : '',
